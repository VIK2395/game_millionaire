...
const ScoreCell = (props) => {
    return (
        <svg className={`score-cell ${props.cell_state}`} width="320" height="32" viewBox="0 0 320 32" fill="none"
            ...
            <text textAnchor="middle" x="50%" dominantBaseline="central" y="50%"
                  fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif" fontSize="16"
                  fill="#1C1C21" fontWeight="400">{props.cell_value}
            </text>
        </svg>
    )
};
